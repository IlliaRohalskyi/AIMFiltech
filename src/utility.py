...
def get_root() -> str:
    ...
    It navigates upwards in the directory tree until it finds the pyproject.toml file.
    ...
    # Navigate upwards in the directory tree until you find the pyproject.toml file
    while not os.path.exists(os.path.join(script_path, "pyproject.toml")):
